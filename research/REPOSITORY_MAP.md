...
| EXP021 层级 CAD 对应 | `core/gdrn_modeling/models/heads/global_hierarchical_cad_head.py` | 固定 64×64 CAD 层级、共享几何 token、GT-parent 细路由、Top-K 联合解码、受限残差及可选 8×8 全局引导；CAD 几何为外部非持久 buffer |
...
| 实验专用验证 | `research/next_pose_head/`、`exp013/`、`exp014/`、`exp017/`、`exp017b/`、`exp018/`、`exp019/`、`exp020/`、`exp021/` | preflight、测试和说明；EXP020 含 matched PnP 与 loss 标定；EXP021 含 hierarchy 生成、B/C preflight、CUDA smoke/标定/profile 及 K-sweep matched evaluator |
