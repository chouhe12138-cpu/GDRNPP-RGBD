...
| `configs/gdrn/research/cad/_base_/` | LM/LM-O 共用、与数据集及实验身份无关的 CAD 模型配置基类 |
| `research/cad_common/` | backbone 配置、preflight 审计、AMP/批次及诊断遥测等中性公共 helper |
...
| `configs/gdrn/lm/research/candidate_cad/`、`research/lm_candidate/` | LM13 非正式候选配置和本地检查；直接继承中性 CAD base，不依赖 LM-O EXP025 配置 |
