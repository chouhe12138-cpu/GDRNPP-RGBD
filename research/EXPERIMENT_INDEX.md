...
| EXP020 Geometry-Aware Correspondence Loss | FORMAL_RUNNING / E10_AVAILABLE | A/B formal 已记录 E5/E10 direct-pose 聚合与逐物体指标；日志快照覆盖 A epoch 15、B epoch 14；E15–E40、run exit code 与 matched PnP 尚未提供 | [RECORD](experiments/EXP-20260909-020-geometry-aware-correspondence-loss/RECORD.md) |
