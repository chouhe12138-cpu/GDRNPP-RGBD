...
| EXP020 Geometry-Aware Correspondence Loss | IMPLEMENTED / LOCAL_TEST_PASS / READY_FOR_EGL_SMOKE | 唯一变量 REPROJ_LW（A=0 / B=1）；首个 release 误用 CPP online training renderer，已改为 EGL，旧 run 不进入科学结论；BOP evaluation 仍用 CPP，等待新 release 重跑 A/B smoke | [RECORD](experiments/EXP-20260909-020-geometry-aware-correspondence-loss/RECORD.md) |
