...
| EXP021 Global-Guided Hierarchical CAD Correspondence | IMPLEMENTED / LOCAL_CUDA_CPP_SMOKE_PASS / EGL_SMOKE_PENDING / FORMAL_NOT_STARTED | 本机 CUDA+CPP 标定与 B/C smoke 已通过并固定初始权重；正式 EGL 确认、B/C formal 与 matched PnP/BOP 待运行 | [RECORD](experiments/EXP-20260914-021-global-guided-hierarchical-cad-correspondence/RECORD.md) |
