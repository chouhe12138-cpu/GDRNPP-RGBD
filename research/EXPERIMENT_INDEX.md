...
| EXP023 LM13 Progressive PCC Fulltrain | CONFIG_AND_LOCAL_SMOKE_PASS / FORMAL_NOT_STARTED | 13 类数据、独立层级、ImageNet ConvNeXt 初始化和本地在线 CUDA smoke 通过；正式训练及 matched 评价未开始 | [RECORD](experiments/EXP-20260918-023-lm13-progressive-pcc-fulltrain/RECORD.md) |
