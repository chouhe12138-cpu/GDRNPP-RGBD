...
| EXP022 Progressive Hierarchical CAD PCC | STAGE1_IMPLEMENTED / LOCAL_CPP_SMOKE_PASS / SERVER_EGL_PENDING | 主层级与独立消融层级已生成，本地 CPU preflight、CUDA+CPP batch4/48 与 evaluator 接线通过；正式训练与完整 matched PnP 尚未运行 | [RECORD](experiments/EXP-20260916-022-progressive-pcc/RECORD.md) |
