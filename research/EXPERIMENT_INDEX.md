...
| EXP020 Geometry-Aware Correspondence Loss | IMPLEMENTED / LOCAL_TEST_PASS / AWAITING_FORMAL_RUN | 唯一变量 REPROJ_LW（A=0 / B=1）；2026-09-09 审查修复完成：matched PnP/RANSAC evaluator（reference 固定 support、A/B 只换 XYZ）、diagnostics 修正、USE_MTL guard、gradient-scale calibration（ratio_raw≈0.075，未改 λ）；identity/非 official smoke 与全部本地测试通过；仍无 formal 训练，无性能声明 | [RECORD](experiments/EXP-20260909-020-geometry-aware-correspondence-loss/RECORD.md) |
