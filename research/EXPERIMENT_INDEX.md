...
| EXP020 Geometry-Aware Correspondence Loss | IMPLEMENTED / LOCAL_TEST_PASS / AWAITING_FORMAL_RUN | 唯一变量 REPROJ_LW（A=0 / B=1）；纯 loss 单测、gdrn_loss 接线、A/B config、CPU preflight 与 GPU 真实数据 smoke 通过；无 formal 训练，无性能声明 | [RECORD](experiments/EXP-20260909-020-geometry-aware-correspondence-loss/RECORD.md) |
