...
| EXP020 Geometry-Aware Correspondence Loss | IMPLEMENTED / LOCAL_TEST_PASS / READY_FOR_FORMAL_RUN | 唯一变量 REPROJ_LW（A=0 / B=1）；matched PnP/RANSAC fixed-support evaluator、diagnostics、USE_MTL guard 与 gradient calibration 已收口；36 项 EXP020 测试及本地 smoke 通过，仍无 formal 性能结果 | [RECORD](experiments/EXP-20260909-020-geometry-aware-correspondence-loss/RECORD.md) |
