...
| EXP024 LM-O Progressive PCC ImageNet Fulltrain | LOCAL_CPU_PREFLIGHT_PASS / SERVER_READONLY_RESOURCES_PASS / EGL_SMOKE_PENDING / FORMAL_NOT_STARTED | 在 EXP022 LM-O 协议上增加独立全主干训练臂：ImageNet ConvNeXt 初始化、物理 batch4 累积至 effective batch48、40 epoch；本地 CPU preflight 与 lab1 只读资源检查通过，EGL/AMP smoke 与正式训练待执行。与冻结臂同时改变初始化和训练范围，差值不作单因素解释 | [RECORD](experiments/EXP-20260919-024-lmo-progressive-pcc-fulltrain/RECORD.md) |
