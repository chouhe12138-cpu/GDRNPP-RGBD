...
| EXP020 Geometry-Aware Correspondence Loss | E40_AVAILABLE / MATCHED_PNP_PENDING / EXIT_CODE_UNCONFIRMED | A/B 已记录全部 E5–E40 direct-pose 聚合及逐物体 ADD；E40 checkpoint 保存见日志；退出码与正式 matched PnP 待补，不据 telemetry 裁决机制 | [RECORD](experiments/EXP-20260909-020-geometry-aware-correspondence-loss/RECORD.md) |
| EXP021 Global-Guided Hierarchical CAD Correspondence | LOCAL_GPU_VECTORIZATION_PASS / FORMAL_TRAINING_ACTIVE_USER_REPORTED / RUN_METADATA_PENDING | loss 与 online geometry 已完成本地 GPU 工程优化、等价测试和损失下降 smoke；加速属于同一 formal 的工程更新，远程训练完成后直接进入 matched PnP/BOP 阶段 | [RECORD](experiments/EXP-20260914-021-global-guided-hierarchical-cad-correspondence/RECORD.md) |
